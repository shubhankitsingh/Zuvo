    ...
    const cardsData = [
        {
            ...
            date: 'April 20, 2025',
            testimonial: "Zuvo made my trip so much easier. The car was delivered right to my door, and the customer service was fantastic!",
            rating:4
        },
        {
            image: assets.puja,
            ...
            date: 'May 10, 2025',
            testimonial:'Zuvo made my trip incredibly easy! The website was simple to use, and the car was perfect. Highly recommend!',
            rating:5
        },
        {
        ...
        },
        {
            ...
            date: 'May 25, 2025',
            testimonial:'Effortless booking and a spotless car. Zuvo delivers every time. Truly a hassle-free experience!',
            rating :5
        },
    ];
                ...
                <div className="flex items-center gap-1">
                    <div className="flex items-center gap-0.5">
                        {Array.from({ length: card.rating }, (_, index) => (
                            <img key={index} src={assets.star_icon} alt="star" width="18" height="18"/>
                        ))}
                    </div>
    ...
    <>
        ...
        `}</style>
            ...
            <div className="marquee-row w-full mx-auto max-w-5xl overflow-hidden relative mt-30">
                <Title title="What Our Customers Say" subTitle="Discover why travelers choose Zuvo for their reliable and convenient car rental experiences."/>
